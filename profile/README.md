# Welcome to NX-Dev-Team 🚀

Building scalable systems, robust mobile applications, and seamless digital experiences.
...
- `[name]-android` — Native Android applications and custom libraries
- `[project]-[platform]` — Fullstack or monorepo projects
...
_Last updated: 2026-06-15 17:54 WIB_

| Rank | Developer | Role | 🟢 PR Kecil | 🟡 PR Sedang | 🔴 PR Besar | 👀 Reviews | 🎯 Issues | ⭐ Score |
| :--: | :-------- | :--- | :---------: | :----------: | :---------: | :--------: | :-------: | :------: |
| 🥇 | [@muhamadsyafii](https://github.com/muhamadsyafii) | Android Engineer | 4 | 0 | 0 | 0 | 0 | **4** |
